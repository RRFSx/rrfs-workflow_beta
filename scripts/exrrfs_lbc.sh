...
ln -snf ${COMINrrfs}/${RUN}.${PDY}/${cyc}/ungrib_lbc/${subdir}/${prefix}:${start_time:0:13} .
ln -snf ${COMINrrfs}/${RUN}.${PDY}/${cyc}/ic/${subdir}/init.nc .
...
${cpreq} ${DATA}/lbc*.nc ${COMOUT}/${task_id}/${subdir}
